...
const Main = () => {
    const featuredRecipes = [
        {
            title: "Moussaka",
            description: "Moussaka is a classic Greek dish made with layers of eggplant, ground meat, and a creamy béchamel sauce, baked to golden perfection.",
            image: "/src/assets/article-1.jpg",
            author: {
                name: <>Felipe1995c<span>&nbsp;&nbsp;</span></>,
                recipes: "33 Recipes"
            },
            rating: 5,
            difficulty: "Beginner",
        ...
        {
            title: "Bibimabop",
            description: "Bibimbap is a colorful Korean rice bowl topped with vegetables, meat, a fried egg, and spicy gochujang, mixed together before eating.",
        ...
        {
            title: "Biryani",
            description: "Biryani is a fragrant South Asian rice dish layered with marinated meat and aromatic spices, slow-cooked to bring out rich flavors.",
            image: "/src/assets/article-3.jpg",
            author: {
                name: <>alextran1985<span>&nbsp;</span></>,
                recipes: "23 Recipes"
            },
            rating: 3,
            difficulty: "Advanced",
    ...
    const renderStars = (rating) => {
        let stars = [];
        for (let i = 0; i < 5; i++) {
            stars.push(i < rating ? <span className="fa fa-star checked" key={i}></span> : <span className="fa fa-star" key={i}></span>);
        }
        return stars;
    };
                    ...
                    {featuredRecipes.map((recipe, index) => (
                        <div className="fcard" key={index}>
                            ...
                            <div className="fcardinfo flex">
                                ...
                                <a href={recipe.link} className="fcardbtn">Read More <i className="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                {threeCards.map((card, index) => (
                    <div className="tcard" key={index}>
                        ...
                        <div className="tcardinfo flex">
                            ...
                            <ul className="flex">
                                <li><i className="fa-solid fa-user"></i> by</li>
                                <li><i className="fa-regular fa-clock"></i> {card.time}</li>
                                <li><i className="fa-regular fa-heart"></i> {card.likes} Like</li>
                            </ul>
                            <a href={card.link} className="tcardbtn">Play Now</a>
                        </div>
                    </div>
                ))}
            </section>
